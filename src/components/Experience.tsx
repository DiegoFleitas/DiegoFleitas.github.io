  ...
  return (
    <li className="relative flex gap-4 sm:gap-6">
      <div className="relative flex shrink-0 flex-col items-center">
        <div
          className="flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-md border-2 border-border bg-[var(--bg-elevated)] text-[10px] font-semibold text-muted"
          aria-hidden
        >
          {showImage ? (
            <img
